% NT: Need to include more practise about when to use partial pressure when calculating C and what it means
\newpage
...
% NT: Build pan evaporation up more slowly. Walk through it step by step with challenges.
% NT: People use conversion to 300K from 298 in book - just set problem at 298K for something.
% eg, how to get gradient from length and difference in mole fraction
